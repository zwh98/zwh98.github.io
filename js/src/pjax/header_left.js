...
function header_left() {
  ...
  $(".header_sidebar").click(function () {
    ...
    if (block == false) {
      ...
      $("body").animate({paddingLeft: "80px"},{duration:500, easing:"easeInOutBack",complete:function () {
      }}
    );
      ...
      $("body").animate({paddingLeft: "0px"},{duration:500, easing:"easeInOutBack",complete:function () {
        }}
      );
